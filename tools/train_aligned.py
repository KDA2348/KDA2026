...
def main(cfg, resume, opts):
    ...
    print(f"GPU Memory Allocated (Before → After): {mem_alloc_before:.2f} MB → {mem_alloc_after:.2f} MB")
    print(f"GPU Memory Reserved (Before → After): {mem_reserved_before:.2f} MB → {mem_reserved_after:.2f} MB")
