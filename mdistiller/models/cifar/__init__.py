...
cifar100_model_prefix: str = os.path.join(
...
cifar_model_dict = {
    ...
    "resnet32x4": (
        resnet32x4,
        cifar100_model_prefix + "resnet32x4_vanilla/best",
    ),
    "ResNet50": (
        ResNet50,
    ...
    "wrn_40_2": (
        wrn_40_2,
        cifar100_model_prefix + "wrn_40_2_vanilla/best",
    ),
    "vgg13": (vgg13_bn, cifar100_model_prefix + "vgg13_vanilla/best"),

    "ShuffleV2": (ShuffleV2, cifar100_model_prefix + "ShuffleV2_vanilla/best"),
    # students
